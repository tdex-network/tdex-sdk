export default interface TraderClientInterface {
    providerUrl: string;
    client: any;
    tradePropose({ baseAsset, quoteAsset, }: {
        baseAsset: string;
        quoteAsset: string;
    }, tradeType: number, swapRequestSerialized: Uint8Array): Promise<Uint8Array>;
    ...
    marketPrice({ baseAsset, quoteAsset, }: {
        baseAsset: string;
        quoteAsset: string;
    }, tradeType: number, amount: number, asset: string): Promise<Array<{
        price?: {
            basePrice: number;
            quotePrice: number;
        };
