...
export interface SwapRequest {
     ...
     *
     * @generated from protobuf field: repeated tdex.v1.UnblindedInput unblinded_inputs = 9;
     */
...
export interface SwapAccept {
     ...
     *
     * @generated from protobuf field: repeated tdex.v1.UnblindedInput unblinded_inputs = 6;
     */
    unblindedInputs: UnblindedInput[];
}
/**
...
class SwapRequest$Type extends MessageType<SwapRequest> {
    ...
    create(value?: PartialMessage<SwapRequest>): SwapRequest {
        const message = { id: "", amountP: "0", assetP: "", amountR: "0", assetR: "", transaction: "", inputBlindingKey: {}, outputBlindingKey: {}, unblindedInputs: [] };
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* map<string, bytes> output_blinding_key */ 8:
                    ...
                    break;
                case /* repeated tdex.v1.UnblindedInput unblinded_inputs */ 9:
    ...
    internalBinaryWrite(message: SwapRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* repeated tdex.v1.UnblindedInput unblinded_inputs = 9; */
...
class SwapAccept$Type extends MessageType<SwapAccept> {
    constructor() {
        super("tdex.v1.SwapAccept", [
            ...
            { no: 6, name: "unblinded_inputs", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => UnblindedInput }
        ]);
    }
    create(value?: PartialMessage<SwapAccept>): SwapAccept {
        const message = { id: "", requestId: "", transaction: "", inputBlindingKey: {}, outputBlindingKey: {}, unblindedInputs: [] };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* map<string, bytes> output_blinding_key */ 5:
                    ...
                    break;
                case /* repeated tdex.v1.UnblindedInput unblinded_inputs */ 6:
                    message.unblindedInputs.push(UnblindedInput.internalBinaryRead(reader, reader.uint32(), options));
                    break;
                default:
                    let u = options.readUnknownField;
    ...
    internalBinaryWrite(message: SwapAccept, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* repeated tdex.v1.UnblindedInput unblinded_inputs = 6; */
        for (let i = 0; i < message.unblindedInputs.length; i++)
            UnblindedInput.internalBinaryWrite(message.unblindedInputs[i], writer.tag(6, WireType.LengthDelimited).fork(), options).join();
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
