/* eslint-disable */
// @generated by protobuf-ts 2.4.0 with parameter client_grpc1,add_pb_suffix,eslint_disable,ts_nocheck,// @generated from protobuf file "tdex/v1/swap.proto" (package "tdex.v1", syntax proto3),// tslint:disable
// @ts-nocheck
...
class SwapRequest$Type extends MessageType<SwapRequest> {
    constructor() {
        super("tdex.v1.SwapRequest", [
            ...
            { no: 2, name: "amount_p", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 3, name: "asset_p", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 4, name: "amount_r", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ },
    ...
    create(value?: PartialMessage<SwapRequest>): SwapRequest {
        const message = { id: "", amountP: 0n, assetP: "", amountR: 0n, assetR: "", transaction: "", inputBlindingKey: {}, outputBlindingKey: {} };
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* uint64 amount_p */ 2:
                    message.amountP = reader.uint64().toBigInt();
                    break;
                case /* string asset_p */ 3:
                    message.assetP = reader.string();
                    break;
                case /* uint64 amount_r */ 4:
                    message.amountR = reader.uint64().toBigInt();
                    break;
