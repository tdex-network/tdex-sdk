/* eslint-disable */
// @generated by protobuf-ts 2.4.0 with parameter client_grpc1,add_pb_suffix,eslint_disable,ts_nocheck,// @generated from protobuf file "tdex/v1/types.proto" (package "tdex.v1", syntax proto3),// tslint:disable
// @ts-nocheck
...
class Fee$Type extends MessageType<Fee> {
    constructor() {
        super("tdex.v1.Fee", [
            { no: 1, name: "basis_point", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 2, name: "fixed", kind: "message", T: () => Fixed }
        ]);
    }
    create(value?: PartialMessage<Fee>): Fee {
        const message = { basisPoint: 0n };
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* int64 basis_point */ 1:
                    message.basisPoint = reader.int64().toBigInt();
                    break;
...
class Fixed$Type extends MessageType<Fixed> {
    constructor() {
        super("tdex.v1.Fixed", [
            { no: 1, name: "base_fee", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 2, name: "quote_fee", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ }
        ]);
    }
    create(value?: PartialMessage<Fixed>): Fixed {
        const message = { baseFee: 0n, quoteFee: 0n };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* int64 base_fee */ 1:
                    message.baseFee = reader.int64().toBigInt();
                    break;
                case /* int64 quote_fee */ 2:
                    message.quoteFee = reader.int64().toBigInt();
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
...
class Balance$Type extends MessageType<Balance> {
    constructor() {
        super("tdex.v1.Balance", [
            { no: 1, name: "base_amount", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ },
            { no: 2, name: "quote_amount", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ }
        ]);
    }
    create(value?: PartialMessage<Balance>): Balance {
        const message = { baseAmount: 0n, quoteAmount: 0n };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* uint64 base_amount */ 1:
                    message.baseAmount = reader.uint64().toBigInt();
                    break;
                case /* uint64 quote_amount */ 2:
                    message.quoteAmount = reader.uint64().toBigInt();
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
