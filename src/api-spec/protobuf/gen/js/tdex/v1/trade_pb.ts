/* eslint-disable */
// @generated by protobuf-ts 2.4.0 with parameter client_grpc1,add_pb_suffix,eslint_disable,ts_nocheck,// @generated from protobuf file "tdex/v1/trade.proto" (package "tdex.v1", syntax proto3),// tslint:disable
// @ts-nocheck
...
class PreviewTradeRequest$Type extends MessageType<PreviewTradeRequest> {
    ...
    create(value?: PartialMessage<PreviewTradeRequest>): PreviewTradeRequest {
        const message = { type: 0, amount: 0n, asset: "" };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
...
class ProposeTradeResponse$Type extends MessageType<ProposeTradeResponse> {
    constructor() {
        super("tdex.v1.ProposeTradeResponse", [
            ...
            { no: 3, name: "expiry_time_unix", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/ }
        ]);
    }
    create(value?: PartialMessage<ProposeTradeResponse>): ProposeTradeResponse {
        const message = { expiryTimeUnix: 0n };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* uint64 expiry_time_unix */ 3:
                    message.expiryTimeUnix = reader.uint64().toBigInt();
                    break;
                default:
                    let u = options.readUnknownField;
                    if (u === "throw")
