...
import { TradeClient } from 'tdex-protobuf/generated/js/TradeServiceClientPb';
...
var TraderClient = /*#__PURE__*/function () {
  function TraderClient(providerUrl) {
    ...
    this.client = new TradeClient(this.providerUrl);
  }
  /**
   * tradePropose
   * @param market
  ...
  _proto.markets = function markets() {
    ...
    return new Promise(function (resolve, reject) {
      _this3.client.markets(new MarketsRequest(), null, function (err, response) {
